<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MarriageCounselingSystem.Login" %>
    ...
    <div id="templatemo_content_wrapper">
		...
		<div id="templatemo_content">
        	...
        	<div class="content_section">
                ...
                <asp:Login ID="CounselorLogin" runat="server" PasswordRecoveryText="Forgot Password" 
            PasswordRecoveryUrl="RetrievePassword.aspx" DestinationPageUrl="Calvary.aspx">
